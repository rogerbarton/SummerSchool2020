...
class Field {
    ...
    void update_host() {
        // TODO: copy contents of device_ptr_ to host_ptr
        auto status = cudaMemcpy(host_ptr_, device_ptr_, sizeof(double) * length(), cudaMemcpyDeviceToHost);
        cuda_check_status(status);
    }

    void update_device() {
        // TODO: copy contents of host_ptr_ to device_ptr_ 
        auto status = cudaMemcpy(device_ptr_, host_ptr_, sizeof(double) * length(), cudaMemcpyHostToDevice);
        cuda_check_status(status);
    }
